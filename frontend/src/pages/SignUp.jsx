  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden" style={{
      ...
      <div className="w-full max-w-md glass-modal rounded-2xl p-8">
        ...
        <h2 className="text-xl font-semibold text-white mb-4 drop-shadow-sm">Sign Up</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <label className="block">
            <span className="text-white font-medium drop-shadow-sm">Full Name</span>
            <input
              type="text"
              value={fullName}
          ...
          <label className="block">
            <span className="text-white font-medium drop-shadow-sm">Confirm Password</span>
            <div className="relative mt-1">
              <input
